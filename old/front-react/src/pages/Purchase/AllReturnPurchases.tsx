...
import {useGetReturnPurchasQuery} from "../../services/medicines/medicines";
...
const AllReturnPurchases = () => {

  const [page, setPage] = useState('1')
 
  const { data, isLoading, isError, isSuccess } = useGetReturnPurchasQuery(page);
            ...
            <div className="card card-default">
              <div className="card-header">
                <h3 className="card-title">
                  <Link to={"/AddReturnPurchas"}>
                    <i className="fa fa-bars"></i>
                    <span className="ms-2">{"Add Return Purchas"}</span>
                  </Link>
                </h3>
              </div>
...
export default AllReturnPurchases;
